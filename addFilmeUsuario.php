	 ...
	 <form method="POST" enctype="multipart/form-data">
		<div class="form-row">
			...
			<div class="form-group col-md-2 pesquisarFilme">
				<button type="submit" class="btn btn-success" name="pesquisarFilmeLivre">Pesquisar</button>
			</div>
...
?>
	 <form method="POST" enctype="multipart/form-data">
		<div class="form-row">
			...
			<div class="form-group col-md-2 pesquisarFilme">
				<button type="submit" class="btn btn-success" name="pesquisarTodosFilme">Pesquisar</button>
			</div>
		</div>
	</form>
...
?>
	 <form method="POST" enctype="multipart/form-data">
		<div class="form-row">
			...
			<div class="form-group col-md-2 pesquisarFilme">
				<button type="submit" class="btn btn-success" name="pesquisarFilmes12">Pesquisar</button>
			</div>
			<div class="form-group col-md-6 pesquisarFilme">
				<i>Lista de filmes recomendados de acordo com sua idade</i>
			</div>
...
?>
	 <form method="POST" enctype="multipart/form-data">
		<div class="form-row">
			...
			<div class="form-group col-md-2 pesquisarFilme">
				<button type="submit" class="btn btn-success" name="pesquisarFilmes14">Pesquisar</button>
			</div>
			<div class="form-group col-md-6 pesquisarFilme">
				<i>Lista de filmes recomendados de acordo com sua idade</i>
			</div>
...
?>
	 <form method="POST" enctype="multipart/form-data">
		<div class="form-row">
			...
			<div class="form-group col-md-2 pesquisarFilme">
				<button type="submit" class="btn btn-success" name="pesquisarFilmes16">Pesquisar</button>
			</div>
			<div class="form-group col-md-6 pesquisarFilme">
				<i>Lista de filmes recomendados de acordo com sua idade</i>
			</div>
